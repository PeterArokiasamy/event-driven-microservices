...
public class CustomerAggregate {
    ...
    public CustomerAggregate(CreateCustomerCommand createCustomerCommand, CustomerRepository customerRepository) {
        ...
        //To start dispatching or publishing events from individual microservices to profile microservices
        ...
        //To publish the event so that the data will be stored inside write database for "single events".
        //AggregateLifecycle.apply(customerCreatedEvent);
        //For multiple events, use below and once first is processed, then second will be dispatched.
    ...
    public void handle(UpdateCustomerCommand updateCustomerCommand, EventStore eventStore) {
        ...
        //Another way to dispatch multiple events
    ...
    public void handle(DeleteCustomerCommand deleteCustomerCommand) {
        ...
        /*
            But for Delete customer event, we are only accepting customer id in existing command class
            So instead of dispatching in handle method, dispatch using Implementation class - deleteCustomer
            using event gateway provided by the Axon framework.
         */
    }
